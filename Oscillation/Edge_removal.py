...
plt.plot(tt, x_1.detach().numpy(), label='Lacl-before', color='#98FB98', linewidth=2.0)
...
plt.plot(tt, x_2.detach().numpy(), label='TetR-before', color='#ADD8E6', linewidth=2.0)
...
plt.plot(tt, x_3.detach().numpy(), label='CI-before', color='#fec194', linewidth=2.0)
