...
# and this file we set k=0.10 default, after train you can get a Parameters_saved_k01.file
# for inferring the structure of the small scale single cell network, we ensemble 15 DNN models
# which has different value of hyperparameter k (k=0.1,0.2,0.3,...,1.5)
...
def train_dynamics_learner(optimizer, dynamics_learner, data, steps, use_cuda, device, adj):
    ...
    for t in range(steps - 1):
        ...
        output = output1 + output3 * 1 - output1 * 1 * adj
...
def main():
    ...
    parser.add_argument('--prediction-steps', type=int, default=7,
                        help='prediction steps in data (default: 7)')
    parser.add_argument('--dynamics-path', type=str, default='Parameters_saved_k01.pickle',
                        help='path to save dynamics learner (default: ./saved/Parameters_saved_k01.pickle)')
