...
plt.subplot(4, 1, 1)
plt.plot(tt, x_1, label='X$_1$-before', color='#98FB98', linewidth=2.0)
...
plt.subplot(4, 1, 2)
plt.plot(tt, x_2, label='X$_2$-before', color='#ADD8E6', linewidth=2.0)
...
plt.subplot(4, 1, 3)
plt.plot(tt, x_3, label='X$_3$-before', color='#fec194', linewidth=2.0)
...
plt.subplot(4, 1, 4)
plt.plot(tt, x_4, label='X$_4$-before', color='#d5b7db', linewidth=2.0)
